    ...
    return{
      pageData:{
        ...
        searchForm:[
					...
					{type:'Input',label:'推文图片路径',prop:'img'},
        ],
        //查询表单内容 end
        //查询条件 start
        queryData:{
        ...
        modalForm:[
					...
					{type:'Input',label:'文章来源作者',prop:'fromAuthor',rules:{required:true,maxLength:100}},
					{type:'Input',label:'推文内容',prop:'content',rules:{required:true,maxLength:65535}},
					{type:'Input',label:'推文图片路径',prop:'img',rules:{required:true,maxLength:500}},
        ],
        //modal表单 end
        //modal 数据 start
        modalData : {//modal页面数据
